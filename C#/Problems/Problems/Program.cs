...
namespace Problems
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            experimenter.RunExperiment(new Problem1(list1, 17, true));
            experimenter.RunExperiment(new Problem1(list2, 50, true));
            experimenter.RunExperiment(new Problem1(list3, 150, true));
            experimenter.RunExperiment(new Problem1(list4, 500, true));
